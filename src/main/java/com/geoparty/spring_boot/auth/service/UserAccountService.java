...
public class UserAccountService {
    ...
    public UserAccountDto saveUser(Integer username, String email, String nickname, boolean userIsWithdraw, String socialId) {
        return UserAccountDto.from(
                userRepository.save(UserAccount.of(username, email, nickname,userIsWithdraw,socialId))
        );
    }
