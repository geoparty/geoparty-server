...
//    private final JwtTokenProvider jwtTokenProvider;
    ...
    //회원 가입 - 이미 가입되어 있다면 찾은거 반환
    public UserAccountDto signUp(String accessToken) {
        KakaoUserData userData = getUserData(accessToken);
    ...
    // 새로고침 시 유저 정보 가져오기
    public UserAccountDto getUser(String socialAccessToken) {
...
//    }
    ...
    // 로그인 -> 프론트에서
//    @Transactional
//    public  signIn(String socialAccessToken) { // 액세스 토큰
